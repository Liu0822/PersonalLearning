...
namespace Glorint.DataBase.Oracle
{
    /// <summary>
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("Glorint.DataBase.Oracle.DLL", "Glorint.Application.Mapping.DLL").Replace("file:///", "");
