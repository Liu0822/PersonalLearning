...
namespace Glorint.DataBase.SqlServer
{
    /// <summary>
    ...
    public class DatabaseContext : DbContext, IDisposable, IObjectContextAdapter
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            string assembleFileName = Assembly.GetExecutingAssembly().CodeBase.Replace("Glorint.DataBase.SqlServer.DLL", "Glorint.Application.Mapping.DLL").Replace("file:///", "");
