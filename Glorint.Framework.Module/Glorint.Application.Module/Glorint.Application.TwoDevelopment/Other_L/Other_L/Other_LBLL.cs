...
namespace Glorint.Application.TwoDevelopment.Other_L
{
    ...
    /// 描 述：Other_L
    /// </summary>
    public class Other_LBLL : Other_LIBLL
    {
        private Other_LService other_LService = new Other_LService();
        ...
        public IEnumerable<Other_LEntity> GetList( string queryJson )
        {
            try
            {
                return other_LService.GetList(queryJson);
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Other_LEntity> GetPageList(Pagination pagination, string queryJson)
        {
            try
            {
                return other_LService.GetPageList(pagination, queryJson);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public Other_LEntity GetEntity(string keyValue)
        {
            try
            {
                return other_LService.GetEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void DeleteEntity(string keyValue)
        {
            try
            {
                other_LService.DeleteEntity(keyValue);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
        ...
        public void SaveEntity(string keyValue, Other_LEntity entity)
        {
            try
            {
                other_LService.SaveEntity(keyValue, entity);
            }
            catch (Exception ex)
            {
                if (ex is ExceptionEx)
