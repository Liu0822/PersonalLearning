...
(function ($, learun) {
    ...
    $.lrselect = {
        ...
        initRender: function (dfop, $self) {
            ...
            if (dfop.allowSearch) {
                var $search = $('<div class="lr-select-option-search"><input type="text" placeholder="搜索关键字，按Enter触发搜索事件"><span class="input-query" title="查询"><i class="fa fa-search"></i></span></div>');
